...
/**
 * Lean version of UserDeviceDocument
 *
...
export type User = {
  ...
  tokenVersion: number;
  mfaTypes: ("emailOtp" | "authenticator")[];
  mfaTempSecret?: any;
  mfaSecret?: any;
  mfaOtp?: string;
  mfaOtpExpiry?: number;
 ...
 *
 * Type of `UserDocument["devices"]` element.
 */
export type UserDeviceDocument = mongoose.Types.Subdocument & {
  ip: string;
  geo: any;
  clientInfo: any;
  token: number;
...
> &
  UserMethods & {
    ...
    secondaryEmailOtpExpiry?: number;
    tokenVersion: number;
    mfaTypes: mongoose.Types.Array<"emailOtp" | "authenticator">;
    mfaTempSecret?: any;
    mfaSecret?: any;
    mfaOtp?: string;
    mfaOtpExpiry?: number;
    ...
    updatedAt?: Date;
    createdAt?: Date;
    devices: mongoose.Types.DocumentArray<UserDeviceDocument>;
  };
